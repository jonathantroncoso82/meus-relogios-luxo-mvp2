...
export const getValuations = async (req: AuthRequest, res: Response) => {
  try {
...
export const createValuation = async (req: AuthRequest, res: Response) => {
  try {
...
export const updateValuation = async (req: AuthRequest, res: Response) => {
  try {
    const { id } = req.params;
